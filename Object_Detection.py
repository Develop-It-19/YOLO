...
#Filter the boxes ((19, 19, 5, 1) which we got after taking the max among each box classes after multiplying each class with Pc) with a threshold.
...
#Compute IoU. We have two corners top-left and bottom-right.
def iou(box1, box2):
